  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-grow flex flex-col items-center justify-center text-center py-10">
        <h1 className="text-4xl font-bold mb-4 text-gray-800">Welcome to Fit Connect</h1>
        <p className="text-lg text-gray-700 mb-8 max-w-md">
          Join our community and take your fitness journey to the next level with challenges, workouts, and support!
        </p>
      ...
      <footer className="bg-gray-800 text-white p-6">
        <div className="container mx-auto text-center">
          <p className="mb-4">&copy; {new Date().getFullYear()} Fit Connect. All Rights Reserved.</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <ul className="text-gray-400">
                ...
                <li><Link href="#">Fitness Guides</Link></li>
              </ul>
            </div>
          </div>
        </div>
